...
import { User, MapPin, Building, Award, FileText, Mail } from 'lucide-react';
        ...
        {(email || linkedin) && (
          <div className="mt-auto pt-3 border-t border-slate-100 flex flex-wrap items-center justify-between gap-2">
            {email && (
              <a
                href={`mailto:${email}`}
                className="inline-flex items-center gap-1.5 text-xs font-medium text-sky-700 hover:text-sky-900 hover:underline transition-colors break-all"
                title={email}
              >
            ...
            {linkedin && (
              <a
                ...
                className="inline-flex items-center gap-1.5 text-xs font-semibold text-sky-700 hover:text-sky-900 hover:underline transition-colors ml-auto"
              >
                {/* LinkedIn SVG icon */}
                <svg
